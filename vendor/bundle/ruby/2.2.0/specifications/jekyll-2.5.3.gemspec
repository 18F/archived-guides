...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<classifier-reborn>, ["~> 2.0"])
      ...
      s.add_development_dependency(%q<rouge>, ["~> 1.7"])
    else
      ...
      s.add_dependency(%q<classifier-reborn>, ["~> 2.0"])
